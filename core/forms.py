...
class ClientForm(forms.ModelForm):
    class Meta:
        model = Client
        fields = [
            'company_name', 'group', 'account_no', 
            'bank_name', 'email', 'first_allocated_person', 'review_person', 
            'year', 'months', 'remark'
        ]
    ...
    def clean(self):
        ...
        for field_name in ['company_name', 'group', 'account_no', 'bank_name', 'first_allocated_person', 'review_person', 'remark']:
